...
pub struct Palette;
impl Palette {
    pub const MAIN_BG: rltk::RGB = RGB{r: 0., g: 0., b: 0.};
    pub const MAIN_FG: rltk::RGB = RGB{r: 0.5, g: 0.5, b: 0.5};
    pub const COLOR_PURPLE: rltk::RGB = RGB{r: 1., g: 0., b: 1.};
    pub const COLOR_RED: rltk::RGB = RGB{r: 1., g: 0., b: 0.};
    pub const COLOR_GREEN: rltk::RGB = RGB{r: 0., g:0.7, b:0.};
    pub const COLOR_GREEN_DARK: rltk::RGB = RGB{r: 0., g: 0.2, b: 0.};
    pub const COLOR_3: rltk::RGB = RGB{r: 0.7, g: 0.2, b: 0.2};
    pub const COLOR_4: rltk::RGB = RGB{r: 0.7, g:0.7, b:0.};
    pub const COLOR_AMBER: rltk::RGB = RGB{r: 1., g:0.74, b:0.};
    pub const COLOR_WOOD: RGB = RGB{r: 0.45, g:0.38, b:0.26};
    pub const COLOR_DIRT: RGB = RGB{r: 0.6, g:0.46, b:0.32};
    pub const COLOR_WATER: RGB = RGB{r: 0.0, g:0.0, b:0.82};
    pub const COLOR_FIRE: RGB = RGB{r: 0.88, g:0.34, b:0.13};
    pub const COLOR_CEDAR: RGB = RGB{r: 0.39, g:0.22, b:0.17};
    pub const COLOR_CLEAR: RGBA = RGBA{r: 0.39, g:0.22, b:0.17, a: 0.0 };
    pub const FACTION_COLORS: [RGB; 2] = [RGB{r: 1.0, g:0., b:0.}, RGB{r: 0.0, g:0.0, b:1.0}];
}
